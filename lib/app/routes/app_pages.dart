...
import '../modules/bindings/hidden_categories_binding.dart';
...
import '../modules/views/hidden_categories_view/hidden_categories_view.dart';
...
class AppPages {
  static final routes = <GetPage>[
    ...
    GetPage(
      name: _Paths.hiddenCategoriesPath,
      page: () => const HiddenCategoriesView(),
    
    binding: HiddenCategoriesBinding(),
    ),
  ];
